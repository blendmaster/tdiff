...
var children, childrenOf, label, postorder, Tree, minMapping, EditDistance, COST, L, genHtml, diag, bindTree, $, $q, $$, input1, error1, raw1, output1, input2, error2, raw2, output2, tree1, tree2, calcDiff, parse, parse1, parse2, slice$ = [].slice, out$ = typeof exports != 'undefined' && exports || this;
children = {

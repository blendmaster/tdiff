...
var $, $q, $$, children, childrenOf, postorder, Tree, D, R, I, HEAP_SIZE, HEAP, nextSize, prgm, EditDistance, POSTORDER_AFFECT, that, BASE, BASE_RENAME, COST, L, supertypeOf, genHtml, textModeParse, slice$ = [].slice, out$ = typeof exports != 'undefined' && exports || this;
...
POSTORDER_AFFECT = 0;
if ((that = $('postorder-affect')) != null) {
  POSTORDER_AFFECT = that.checked ? 1 : 0;
...
out$.COST = COST = {
  ...
  renaming: function(lgraph, rgraph, left, right){
    ...
    exactRename = depthDiff + POSTORDER_AFFECT * postorderWeight;
